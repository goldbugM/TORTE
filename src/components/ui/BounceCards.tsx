  ...
  return (
    ...
    >
      {images.map((src, idx) => (
        <div
          key={idx}
          className={`bounce-card bounce-card-${idx} absolute w-48 aspect-square border-4 border-white rounded-3xl overflow-hidden shadow-lg cursor-pointer transition-all duration-300 hover:shadow-xl`}
          style={{
